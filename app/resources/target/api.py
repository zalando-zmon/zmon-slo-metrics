...
class TargetResource(ResourceHandler):
    ...
    def new_object(self, target: dict, **kwargs) -> Target:
        ...
        fields['target_from'] = target.get('from', float('-inf'))
        fields['target_to'] = target.get('to', float('inf'))
    ...
    def update_object(self, obj: Target, target: dict, **kwargs) -> Target:
        ...
        obj.target_from = target.get('from', float('-inf'))
        obj.target_to = target.get('to', float('-inf'))
