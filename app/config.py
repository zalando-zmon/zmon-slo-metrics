...
# OPENTRACING
OPENTRACING_TRACER = os.getenv('OPENTRACING_TRACER', None)
OPENTRACING_TRACER_SERVICE_NAME = os.getenv('OPENTRACING_SERVICE_NAME', 'slr-backend')
OPENTRACING_TRACER_KEY = os.getenv('OPENTRACING_TRACER_KEY', '')
OPENTRACING_TRACER_HOST = os.getenv('OPENTRACING_TRACER_HOST', '')
OPENTRACING_TRACER_PORT = os.getenv('OPENTRACING_TRACER_PORT', 443)
